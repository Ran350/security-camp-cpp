...
BinaryFileWriter::BinaryFileWriter() : m_pImpl{std::make_shared<Impl>()} {}
...
BinaryFileWriter::operator bool() const noexcept { return m_pImpl->isOpen(); }
...
void BinaryFileWriter::close() { m_pImpl->close(); }
