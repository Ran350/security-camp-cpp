...
BinaryFileReader::BinaryFileReader() : m_pImpl{std::make_shared<Impl>()} {}
...
bool BinaryFileReader::isOpen() const noexcept { return m_pImpl->isOpen(); }

BinaryFileReader::operator bool() const noexcept { return m_pImpl->isOpen(); }
...
void BinaryFileReader::close() { m_pImpl->close(); }

int64 BinaryFileReader::size() const noexcept { return m_pImpl->size(); }
