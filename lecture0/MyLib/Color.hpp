...
struct Color
{
    ...
    explicit constexpr Color(std::integral auto rgb) noexcept
        : r{static_cast<uint8>(rgb)}, g{static_cast<uint8>(rgb)},
          b{static_cast<uint8>(rgb)}, a{255}
    {
    }
    ...
    constexpr Color(std::integral auto rgb, std::integral auto _a) noexcept
        : r{static_cast<uint8>(rgb)}, g{static_cast<uint8>(rgb)},
          b{static_cast<uint8>(rgb)}, a{static_cast<uint8>(_a)}
    {
    }
    ...
    /// @param _b B 成分 [0, 255]
    [[nodiscard]]
    constexpr Color(std::integral auto _r, std::integral auto _g,
                    std::integral auto _b) noexcept
        : r{static_cast<uint8>(_r)}, g{static_cast<uint8>(_g)},
          b{static_cast<uint8>(_b)}, a{255}
    {
    }
    ...
    [[nodiscard]]
    constexpr Color(std::integral auto _r, std::integral auto _g,
                    std::integral auto _b, std::integral auto _a) noexcept
        : r{static_cast<uint8>(_r)}, g{static_cast<uint8>(_g)},
          b{static_cast<uint8>(_b)}, a{static_cast<uint8>(_a)}
    {
    }
    ...
    {
        return ((0.299 / 255.0 * r) + (0.587 / 255.0 * g) +
                (0.114 / 255.0 * b));
    }
...
template <> struct std::formatter<seccamp::Color>
{
