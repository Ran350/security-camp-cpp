...
int main()
{
    std::println("---- Common.hpp ----");
    {
        ...
        std::println("SECCAMPLIB_VERSION_REVISION:  {}",
                     SECCAMPLIB_VERSION_REVISION);
        std::println("SECCAMPLIB_VERSION_NUMBER:  {}",
                     SECCAMPLIB_VERSION_NUMBER);
    ...
    std::println("---- Utility.hpp ----");
    {
        ...
        std::println("ToLower(\"Hello, seccamp!\"): {}",
                     ToLower("Hello, seccamp!"));
        std::println("ToUpper(\"Hello, seccamp!\"): {}",
                     ToUpper("Hello, seccamp!"));
    }
    ...
    {
        std::println("FileSystem::FullPath(\"test.txt\"): {}",
                     FileSystem::FullPath("asset/test.txt"));
        std::println("FileSystem::Extension(\"test.txt\"): {}",
                     FileSystem::Extension("asset/test.txt"));
        std::println("FileSystem::Extension(\"test\"): {}",
                     FileSystem::Extension("test"));
    }
    ...
    {
        BinaryFileWriter writer{"asset/test.bin"};
    ...
    {
        BinaryFileReader reader{"asset/test.bin"};
    ...
    {
        TextFileWriter writer{"asset/test.txt"};
        std::println("writer.isOpen(): {}", writer.isOpen());
        std::println("writer.fullPath(): {}", writer.fullPath());
    ...
    {
        TextFileReader reader{"asset/test.txt"};
        std::println("reader.isOpen(): {}", reader.isOpen());
        std::println("reader.fullPath(): {}", reader.fullPath());
    ...
    {
        {
            ...
            image.save("asset/image.bmp");
        }

        {
            Image image{"asset/image.bmp"};
            ...
            image.save("asset/image2.bmp");
        }

        {
            Image image{"asset/seccamp.bmp"};
            ...
            image.save("asset/seccamp_gray.bmp");
        }
    }
}
